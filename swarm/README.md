...
[![Travis](https://travis-ci.org/etherark/etherark.svg?branch=master)](https://travis-ci.org/etherark/etherark)
...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/ether-ark/etherark

    go install github.com/ether-ark/etherark/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/ether-ark/etherark`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/ether-ark/etherark
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/ether-ark/etherark/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/ether-ark/etherark/wiki/Code-Review-Guidelines).
