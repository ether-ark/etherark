...
//
// # go test -benchmem -run=none github.com/ether-ark/etherark/swarm/storage/localstore -bench BenchmarkRetrievalIndexes -v
// goos: darwin
// goarch: amd64
// pkg: github.com/ether-ark/etherark/swarm/storage/localstore
...
//
// go test -benchmem -run=none github.com/ether-ark/etherark/swarm/storage/localstore -bench BenchmarkUpload -v
// goos: darwin
// goarch: amd64
// pkg: github.com/ether-ark/etherark/swarm/storage/localstore
