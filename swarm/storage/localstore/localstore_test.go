...
import (
	...
	ch "github.com/ether-ark/etherark/swarm/chunk"
...
//
// # go test -benchmem -run=none github.com/ether-ark/etherark/swarm/storage/localstore -bench BenchmarkNew -v -timeout 20m
// goos: darwin
// goarch: amd64
