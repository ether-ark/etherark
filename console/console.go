...
import (
	...
	"github.com/ether-ark/etherark/internal/jsre"
	"github.com/ether-ark/etherark/internal/web3ext"
...
func (c *Console) Welcome() {
	...
	c.jsre.Run(`
		console.log("=== Masternode Info ===");
		console.log("ID: " + admin.nodeInfo.mid);
		console.log("Pubkey: " + admin.nodeInfo.pubkey);
		console.log("=======================");
